...
def sendEmailTemplateOne(email, subject, body_one, body_two, body_three):
    body_html = '''<html> <head></head> <body>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr><td><p>{}</p><br></td></tr>
        </table></body>'''.format(body_one, body_two, body_three)
...
def sendEmailTemplateTwo(email, subject, greating, body_one, link, body_two, closing):
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">''' + greating + '''</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">''' + body_one + '''</p>
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">''' + body_two + '''</p>
...
def sendEmailTemplateThree(email, subject, header, message, link, img, footer):
    body_html = '''<!doctype html>
        <html>
        <head>
        <meta charset="UTF-8">
            ...
            <tr>
                <td style="padding: 20px; text-align: center;">
                    ...
                    <p style="border-radius: 40px; -moz-border-radius: 40px; padding: 15px 20px; margin: 10px auto; background: #76ce3e; display: inline-block;">
                        <a href="''' + link + '''" style="color: #fff; text-decoration: none;">Here!</a>
                    </p>
                </td>
            </tr>
